 ...
 *
 * This file simply creates a Kitty object type using the interface AnimalCard.
 * The Kitty object has parameters (Image, Location, DrawingCanvas).
 */
...
{
  private static String KITTY_SPEAK = "Meow"; // What the Cow says
  private        Color highlightColor;        // Highlight Color (Green or Red)
  private        VisibleImage kittyPic;       // The Image file (jpg)
  ...
  /*
   * Name:       Kitty
   * Purpose:    This constructor defines the Kitty object.
   * Parameters: pic:    The image file (kitty.jpg in this case)
   *             loc:    The top-left corner of the Kitty object
   *             canvas: The canvas that Kitty is made on
   * Return:     N/A
   */

  public Kitty(Image pic, Location loc, DrawingCanvas canvas)
  {
    kittyPic = new VisibleImage( pic, loc, canvas );  // Create image on canvas
  ...
  public String speak()
  {
    return KITTY_SPEAK; // Return what the animal says
  }
  ...
  {
    return kittyPic.contains(point); // Does the animal card contain the point?
  }
...
} // End of public class Kitty implements AnimalCard
